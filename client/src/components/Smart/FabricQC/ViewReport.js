...
class ViewReport extends Component {
    ...
    handleDeptChange = (event) => {
        ...
        axios.get(`/api/fabricqc/listfolder/${value}`)
            .then((res) => {
        ...
        return(
            <Aux>
                <Row className="show-grid">
                    <Col xs={12} sm={12}>
                        <legend>View Fabric QC Report</legend>
                    </Col>
                </Row>
                <Row className="show-grid">
                    <Col xs={12} sm={12}>
                        ...
                        <Form layout="vertical">
                            <FormItem label="Choose report type">
                                <RadioGroup onChange={this.handleDeptChange} value={this.state.dept}>
                                    <Radio value="FQC">General Report</Radio>
                                    <Radio value="4D">4 Points Testing</Radio>
                                    <Radio value="PM">Color separation</Radio>
                                </RadioGroup>
                            </FormItem>
